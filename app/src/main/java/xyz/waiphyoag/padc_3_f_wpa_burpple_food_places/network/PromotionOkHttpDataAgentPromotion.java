...
public class PromotionOkHttpDataAgentPromotion implements PromotionFoodsDataAgent {
    private static PromotionOkHttpDataAgentPromotion objInstance;
    private PromotionOkHttpDataAgentPromotion()
    {

    }
    public static PromotionOkHttpDataAgentPromotion getObjInstance ()
    {
        if (objInstance==null)
        {
            objInstance=new PromotionOkHttpDataAgentPromotion();
        }
        return objInstance;
    }
    ...
    public void loadfoods() {
        new LoadNewsTask().execute("http://padcmyanmar.com/padc-3/burpple-food-places/apis/v1/getPromotions.php");
